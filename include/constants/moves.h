...
// Reverse Path
#define MOVE_BLAZING_TORQUE_REVERSE 848
#define MOVE_WICKED_TORQUE_REVERSE 849
#define MOVE_COMBAT_TORQUE_REVERSE 850
#define MOVE_MAGICAL_TORQUE_REVERSE 851
