...
#define ANIM_EXIT_POKEBALL_FAST_SOUTH (ANIM_STD_COUNT + 5)
#define ANIM_EXIT_POKEBALL_FAST_NORTH (ANIM_STD_COUNT + 6)
#define ANIM_EXIT_POKEBALL_FAST_WEST  (ANIM_STD_COUNT + 7)
#define ANIM_EXIT_POKEBALL_FAST_EAST  (ANIM_STD_COUNT + 8)
