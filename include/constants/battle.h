...
enum MoveEffects
{
    ...
    MOVE_EFFECT_ATK_PLUS_ARG,
    MOVE_EFFECT_DEF_PLUS_ARG,
    MOVE_EFFECT_SPD_PLUS_ARG,
    MOVE_EFFECT_SP_ATK_PLUS_ARG,
    MOVE_EFFECT_SP_DEF_PLUS_ARG,
    MOVE_EFFECT_ACC_PLUS_ARG,
    MOVE_EFFECT_EVS_PLUS_ARG,
    MOVE_EFFECT_ATK_MINUS_ARG,
    MOVE_EFFECT_DEF_MINUS_ARG,
    MOVE_EFFECT_SPD_MINUS_ARG,
    MOVE_EFFECT_SP_ATK_MINUS_ARG,
    MOVE_EFFECT_SP_DEF_MINUS_ARG,
    MOVE_EFFECT_ACC_MINUS_ARG,
    MOVE_EFFECT_EVS_MINUS_ARG,
    MOVE_EFFECT_RAPID_SPIN,
    MOVE_EFFECT_YAWN,
    MOVE_EFFECT_CURSE,
