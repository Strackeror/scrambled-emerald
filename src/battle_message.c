...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_TRYTOLEARNMOVE1]                      = COMPOUND_STRING("{B_BUFF1} can now learn {B_BUFF2}.\p"),
    ...
    [STRINGID_PKMNJAWLOCKED]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} trapped {B_DEF_NAME_WITH_PREFIX2} in its jaw!"),
    [STRINGID_PKMNVISEGRIPPED]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was gripped by {B_ATK_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_PLAYERPAIDPRIZEMONEY]                 = COMPOUND_STRING("You were overwhelmed by your defeat!{PAUSE_UNTIL_PRESS}"),
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    [B_MSG_WRAPPED_JAW_LOCK]    = STRINGID_PKMNJAWLOCKED,          // MOVE_JAW_LOCK
    [B_MSG_WRAPPED_VISE_GRIP]   = STRINGID_PKMNVISEGRIPPED,        // MOVE_VISE_GRIP
};
