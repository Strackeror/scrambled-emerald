...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_GLARE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS(
            {.moveEffect = MOVE_EFFECT_PARALYSIS,},
            {.moveEffect = MOVE_EFFECT_ATK_MINUS_1,.chance = 100,},
            {.moveEffect = MOVE_EFFECT_SP_ATK_MINUS_1,.chance = 100,},
        ),
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_MEGAHORN] =
    {
        ...
        .slicingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS(
            {.moveEffect = MOVE_EFFECT_DEF_MINUS_1,.self = TRUE,},
            {.moveEffect = MOVE_EFFECT_SP_DEF_MINUS_1,.self = TRUE,},
        ),
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_AROMATHERAPY] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS(
            {.moveEffect = MOVE_EFFECT_ATK_PLUS_1,.chance = 100,},
            {.moveEffect = MOVE_EFFECT_SP_ATK_PLUS_1,.chance = 100,},
            {.moveEffect = MOVE_EFFECT_SPD_PLUS_2,.chance = 100,},
        ),
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_FREEZE_SHOCK] =
    {
        ...
        .instructBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS(
            {.moveEffect = MOVE_EFFECT_PARALYSIS,.chance = 100,},
            {.moveEffect = MOVE_EFFECT_ABSORB, .argument = 4}
        ),
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_SPARKLY_SWIRL] =
    {
        ...
        .description = COMPOUND_STRING("DOESN'T EXIST IN SCARLET AND VIOLET."),
        .effect = EFFECT_DO_NOTHING, // Temprorary
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 120 : 90,
        .type = TYPE_FAIRY,
    ...
    [MOVE_CLANGOROUS_SOUL] =
    {
        ...
        .argument.status = ARG_LONGER_STATUS,
    },
    ...
    [MOVE_DOUBLE_SHOCK] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS(
            {.moveEffect = MOVE_EFFECT_PARALYSIS},
            {.moveEffect = MOVE_EFFECT_REMOVE_ARG_TYPE, .self = TRUE}
        ),
