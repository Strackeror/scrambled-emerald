...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/koraidon.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/koraidon.bin.lz");
