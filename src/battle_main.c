...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 10, BALL_GREAT },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_GREAT },
    [TRAINER_CLASS_AQUA_LEADER] = { _("TEAM STAR"), 20, BALL_GREAT },
    ...
    [TRAINER_CLASS_GENTLEMAN] = { _("DIRECTOR"), 20, BALL_LUXURY },
    ...
    [TRAINER_CLASS_AI_PROFESSOR] = { _("AI PROFESSOR"), 50, BALL_MASTER },
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = { _("TEAM STAR"), 20, BALL_MASTER },
    ...
    [TRAINER_CLASS_ARENA_TYCOON] = { _("TEAM STAR") },
...
static void CB2_InitBattleInternal(void)
{
    ...
    if (gBattleTypeFlags & BATTLE_TYPE_TRAINER && TRAINER_BATTLE_PARAM.opponentA == TRAINER_OGERPON) {
...
static void TryChangingTurnOrderEffects(u32 battler1, u32 battler2, u32 *quickClawRandom, u32 *quickDrawRandom)
{
    ...
    if (!gProtectStructs[battler1].quickDraw
     && ((holdEffectBattler1 == HOLD_EFFECT_QUICK_CLAW)
    ...
    if (!gProtectStructs[battler2].quickDraw
     && ((holdEffectBattler2 == HOLD_EFFECT_QUICK_CLAW)
...
static void HandleEndTurn_BattleWon(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER && !(gBattleTypeFlags & BATTLE_TYPE_LINK))
    {
        ...
        case TRAINER_CLASS_AI_PROFESSOR:
